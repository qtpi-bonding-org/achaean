...
import 'package:achaean_client/src/protocol/koinon/cached_post.dart' as _i9;
...
class EndpointKoinon extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i9.CachedPost>> getAgora(
    String polisRepoUrl, {
    required int limit,
    required int offset,
  }) => caller.callServerEndpoint<List<_i9.CachedPost>>(
    'koinon',
    'getAgora',
    {
      'polisRepoUrl': polisRepoUrl,
  ...
  _i2.Future<List<_i9.CachedPost>> getPersonalFeed({
    required int limit,
    required int offset,
  }) => caller.callServerEndpoint<List<_i9.CachedPost>>(
    'koinon',
  ...
  _i2.Future<List<_i9.CachedPost>> getThread(
    String authorPubkey,
    String path,
  ) => caller.callServerEndpoint<List<_i9.CachedPost>>(
    'koinon',
