...
import 'package:achaean_server/src/generated/koinon/cached_post.dart' as _i10;
...
class _KoinonEndpoint {
  ...
  _i3.Future<List<_i10.CachedPost>> getAgora(
    _i1.TestSessionBuilder sessionBuilder,
    String polisRepoUrl, {
    required int limit,
    required int offset,
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i10.CachedPost>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<List<_i10.CachedPost>> getPersonalFeed(
    _i1.TestSessionBuilder sessionBuilder, {
    required int limit,
    required int offset,
  }) async {
  ...
  _i3.Future<List<_i10.CachedPost>> getThread(
    _i1.TestSessionBuilder sessionBuilder,
    String authorPubkey,
    String path,
  ) async {
