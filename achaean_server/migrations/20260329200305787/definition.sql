...
--
-- Class ObserveDeclarationRecord as table koinon_observe_declarations
--
...
--
-- Class PolisDefinition as table koinon_polis_definitions
--
...
--
-- Class PolitaiUser as table koinon_politai_users
--
...
--
-- Class ReadmeSignatureRecord as table koinon_readme_signatures
--
...
--
-- Class TrustDeclarationRecord as table koinon_trust_declarations
--
...
--
-- Class FlagRecord as table koinon_flag_records
--
...
--
-- Class PostReference as table koinon_post_references
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('achaean', '20260329200305787', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260329200305787', "timestamp" = now();
