...
import 'package:koinon_index_core_server/src/generated/politai_user.dart'
    as _i4;
import 'package:koinon_index_core_server/src/generated/relationships.dart'
    as _i5;
...
import 'package:koinon_index_core_server/src/generated/polis_member.dart'
    as _i7;
import 'package:koinon_index_core_server/src/generated/protocol.dart';
import 'package:koinon_index_core_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  late final _KoinonCoreEndpoint koinonCore;
}
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    koinonCore = _KoinonCoreEndpoint(
      endpoints,
...
class _KoinonCoreEndpoint {
  ...
  _i3.Future<_i4.PolitaiUser?> getUser(
    _i1.TestSessionBuilder sessionBuilder,
    String pubkey,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<_i5.Relationships> getRelationships(
    _i1.TestSessionBuilder sessionBuilder,
    String pubkey,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i5.Relationships>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
